...
namespace Game
{
    public class Squid_AI : MonoBehaviour
    {
        private AI _ai;
        ...
        private void Awake()
        {
            ...
            StaticBus<Event_Squid_Win>.Subscribe(PlayerWin);
        ...
        {
            StaticBus<Event_Squid_Win>.Unsubscribe(PlayerWin);
            StaticBus<Event_Player_Die>.Unsubscribe(PlayerLose);
        }

        [Button]
        public void TakeWeapon(RuntimeAnimatorController _animator, int id)
        {
            _ai.GetComponent<AIFollowWaypoint>().isCombat = true;
            SetUpVision(_animator, id);
            ChangeBehavior();
        }

        public void SetUpVision(RuntimeAnimatorController _animator, int id)
        {
            if (weapon == null)
            {
        ...
        void PlayerWin(Event_Squid_Win e)
        {
            GameStop();
        }
