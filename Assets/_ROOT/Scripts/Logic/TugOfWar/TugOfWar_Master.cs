...
namespace Game
{
    public class TugOfWar_Master : MonoBehaviour
    {
        ...
        private TugOfWar_GUI _gui;
        private bool _isFinished = false;
        private bool _isInitialized = false;
        public TugOfWar_GUI gui { get { return _gui; } }
        ...
        private async UniTaskVoid ConstructStart()
        {
            ...
            _gui = view.GetComponent<TugOfWar_GUI>();

            StaticBus<Event_TurOfWar_Constructed>.Post(null);
        }
